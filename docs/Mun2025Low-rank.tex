...
% Данный шаблон взят из работы Казачков Даниила, так как пока недостаточно знаний по LaTex. Позже он будет переписан.
...
\author{Pavel Mun, Nikita Okhotnikov}
\title{\textbf{Low-rank self-play fine-tuning for small LLMs}}
\date{\today}
